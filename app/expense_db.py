...
def mark_reimbursement_documents_generated(rid): return _service().mark_documents_generated(rid)
...
def get_invoices(reimbursement_id=None, status=None, limit=500, offset=0): return _service().list_invoices(reimbursement_id, status, limit=limit, offset=offset)
...
def get_payments(reimbursement_id=None, status=None, limit=500, offset=0): return _service().list_payments(reimbursement_id, status, limit=limit, offset=offset)
